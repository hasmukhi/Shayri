...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        catimg = new int[]{R.drawable.moti, R.drawable.life, R.drawable.love, R.drawable.positive, R.drawable.fship};
...
//            ArrayList<categories> cats = new ArrayList<>();
                ...
                gridView = (GridView) findViewById(R.id.main_grid1);
                CustomGrid customGrid = new CustomGrid(MainActivity.this, postArrayList, catimg);
